...
<p style="text-align: center;">
	<?php esc_html_e( 'Your student', 'sensei-lms' ); ?> <strong><?php echo esc_html( $learner_name ); ?></strong> <?php esc_html_e( 'has started the course', 'sensei-lms' ); ?> <strong>"<?php echo esc_html( get_the_title( $course_id ) ); ?>"</strong>
</p>

<p style="text-align: center;">
	<a href="<?php echo esc_url( admin_url( 'admin.php?page=sensei_learners&view=learners&course_id=' . $course_id ) ); ?>" style="<?php echo esc_attr( $button ); ?>"><?php esc_html_e( 'Manage this course\'s learners', 'beflex-child' ); ?></a>
</p>
