...
<p style="text-align: center;">
	...
	printf( esc_html__( 'has completed the lesson', 'sensei-lms' ), esc_html( $passed ) );
	?>
	<strong> <?php echo esc_html( get_the_title( $lesson_id ) ); ?></strong>
</p>

<p style="text-align: center;">
	<a href="<?php echo esc_url( admin_url( 'admin.php?page=sensei_learners&view=learners&lesson_id=' . $lesson_id ) ); ?>" style="<?php echo esc_attr( $button ); ?>"><?php esc_html_e( 'Manage this lesson\'s learners', 'beflex-child' ); ?></a>
</p>
