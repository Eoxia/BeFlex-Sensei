...
<p style="text-align: center;">
	...
	?>
	<strong> <?php echo esc_html( $content_title ); ?></strong>
</p>
...
<p style="text-align: center;">
	<a href="<?php echo esc_url( get_permalink( $message_id ) ); ?>" style="<?php echo esc_attr( $button ); ?>"><?php esc_html_e( 'Reply to this message', 'beflex-child' ); ?></a>
</p>
